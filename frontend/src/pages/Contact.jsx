  ...
  return (
    <div className="flex w-full h-screen">
      ...
      <div className="w-1/2 h-full flex items-center justify-center bg-white px-8 py-16" style={{ backgroundImage: `url(${celticknot})` }}>
        <div className="w-4/4 w-full bg-white p-8 rounded-lg shadow-lg" >
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <form className="space-y-6">
            <div>
              <label htmlFor="name" className="block font-semibold text-left text-gray-700">
                Name
              </label>
           ...
           {/* Email Input Field */}
            <div>
              <label htmlFor="email" className="block font-semibold text-left text-gray-700">
                Email
              </label>
              <div className="relative mt-1">
            ...
            {/* Message Input Field */}
            <div>
              <label htmlFor="message" className="block font-semibold text-left text-gray-700">
                Message
              </label>
                <textarea
                  id="message"
